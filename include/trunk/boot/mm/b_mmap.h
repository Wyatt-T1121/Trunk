 ...
 *            Extracts the memory map and module address into BootInfo.         *
...
namespace trunk::boot
{
     ...
     *  FUNC    : parse_mb2                                                         *
     *  DATE    : 2026                                                              *
     *  PURPOSE : Walk all MB2 tags from mb2_phys and populate info.                *
     *            Returns the physical address of the first module tag found        *
